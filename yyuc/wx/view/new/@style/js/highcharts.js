...
(function() {
    ...
    function Ab(a, b) {
        var c = b || [[Bb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [ib, [1, 2, 5, 10, 15, 30]], [Va, [1, 2, 5, 10, 15, 30]], [Ka, [1, 2, 3, 4, 6, 8, 12]], [ma, [1, 2]], [Wa, [1, 2]], [La, [1, 2, 3, 4, 6]], [va, null]],
        d = c[c.length - 1],
        e = D[d[0]],
        f = d[1],
        g;
    ...
    function Cb(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            b = 1;
            h = i[Ya]();
            for (var d = i.getTime(), l = i[Xa](), m = i[Ma](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d),
            j === D[va] ? d = Za(h + b * k, 0) : j === D[La] ? d = Za(h, l + b * k) : !g && (j === D[ma] || j === D[Wa]) ? d = Za(h, l, m + b * k * (j === D[ma] ? 1 : 7)) : (d += j * k, j <= D[Ka] && d % D[ma] === i && (f[d] = ma)),
            b++;
            e.push(d)
        }
        e.info = x(a, {
    ...
    Sa,
    Ba = C.documentElement.ontouchstart !== A,
    Nb = {},
    tb = 0,
    $a,
    N,
    ...
    ub = {
        ...
        L.HighchartsAdapter = L.HighchartsAdapter || a && {
            ...
            fireEvent: function(b, c, d, e) {
                var f = a.Event(c),
                g = "detached" + c,
                h; ! Ea && d && (delete d.layerX, delete d.layerY);
                x(f, d);
    ...
    var qa = function(a) {
        var b = [],
        c; (function(a) { (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(a)) ? b = [z(c[1]), z(c[2]), z(c[3]), parseFloat(c[4], 10)] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) && (b = [z(c[1], 16), z(c[2], 16), z(c[3], 16), 1])
        })(a);
        return {
            get: function(c) {
    ...
    ya.prototype = {
        ...
        attr: function(a, b) {
            ...
            p = w(g, c) || this[c] || 0,
            c !== "d" && c !== "visibility" && (p = parseFloat(p));
                ...
                e || (e = C.createElementNS(oa, "title"), g.appendChild(e)),
                e.textContent = d;
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (ra !== this.cTT) {
                        if (r(j)) a.isSVG ? (t = Ea ? "-ms-transform": bb ? "-webkit-transform": cb ? "MozTransform": Lb ? "-o-transform": "", k[t] = k.transform = "rotate(" + j + "deg)") : (q = j * ab, p = W(q), q = Z(q), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", p, ", M12=", -q, ", M21=", q, ", M22=", p, ", sizingMethod='auto expand')"].join("") : Q),
                        I(b, k);
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    ...
                    if (d) a.width = M(c * Z(f)) + M(b * W(f)),
                    a.height = M(c * W(f)) + M(b * Z(f))
                }
                this.bBox = a
            }
            return a
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) w(f, "height", s(w(f, "height") - h, 0)),
                    f.cutHeight = h;
    ...
    sa.prototype = {
        ...
        buildText: function(a) {
            for (var b = a.element,
            c = n(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = w(b, "x"), h = a.styles, i = h && h.width && z(h.width), j = h && h.lineHeight, k, h = d.length, l = []; h--;) b.removeChild(d[h]);
            ...
            function(c, d) {
                ...
                function(c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        y ? m.dx = 3 : m.x = g;
                        if (!y) {
                            if (d) { ! ca && a.renderer.forExport && I(n, {
                                    display: "block"
                                });
                                t = L.getComputedStyle && z(L.getComputedStyle(k, null).getPropertyValue("line-height"));
                                if (!t || isNaN(t)) {
                                    var r;
                                    if (! (r = j)) if (! (r = k.offsetHeight)) l[d] = b.getBBox ? b.getBBox().height: a.renderer.fontMetrics(b.style.fontSize).h,
                                    r = u(l[d] - (l[d - 1] || 0)) || 18;
                                    t = r
                                }
                                w(n, "dy", t)
                        ...
                        b.appendChild(n);
                        y++;
                        if (i) for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), E = []; c.length || E.length;) delete a.bBox,
                        r = a.getBBox().width,
                        m = r > i,
                        !m || c.length === 1 ? (c = E, E = [], c.length && (n = C.createElementNS(oa, "tspan"), w(n, {
                            dy: j || 16,
                            x: g
                        }), o && w(n, "style", o), b.appendChild(n), r > i && (i = r))) : (n.removeChild(n.firstChild), E.unshift(c.pop())),
                        c.length && n.appendChild(C.createTextNode(c.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        },
        button: function(a, b, c, d, e, f, g) {
            ...
            e = B(ia(wb, 1, "stroke", "#999", "fill", ia("linearGradient", a, "stops", [[0, "#FFF"], [1, "#DDD"]]), "r", 3, "padding", 3, "style", ia("color", "black")), e);
            l = e.style;
            delete e.style;
            f = B(e, ia("stroke", "#68A", "fill", ia("linearGradient", a, "stops", [[0, "#FFF"], [1, "#ACF"]])), f);
            m = f.style;
            delete f.style;
            g = B(e, ia("stroke", "#68A", "fill", ia("linearGradient", a, "stops", [[0, "#9BD"], [1, "#CDF"]])), g);
            q = g.style;
            delete g.style;
            ...
            h.setState = function(a) { (i = a) ? a === 2 && h.attr(g).css(q) : h.attr(e).css(l)
            };
            return h.on("click",
            function() {
                d.call(h)
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (z) {
                    if (!n) a = h ? -zb: 0,
                    p.box = n = d ? q.symbol(d, -ra * v, a, p.width, p.height) : q.rect( - ra * v, a, p.width, p.height, 0, w[wb]),
                    n.add(p);
                    n.attr(B({
                        width: p.width,
                        height: p.height
            ...
            function k() {
                ...
                if (r(s) && (a === "center" || a === "right")) b += {
                    center: 0.5,
                    right: 1
                } [a] * (s - H.width); (b !== y.x || c !== y.y) && y.attr({
                    x: b,
                    y: c
                });
                y.x = b;
    ...
    if (!ca && !V) {
        ha = {
            init: function(a, b) {
                ...
                d = ["position: ", "absolute", ";"]; (b === "shape" || b === ga) && d.push("left:0;top:0;width:1px;height:1px;");
                Ra && d.push("visibility: ", b === ga ? "hidden": "visible");
                c.push(' style="', d.join(""), '"/>');
                if (b) c = b === ga || b === "span" || b === "img" ? c.join("") : a.prepVML(c),
                this.element = T(c);
                this.renderer = a;
                this.attrSetters = {}
            },
            ...
            attr: function(a, b) {
                ...
                p = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight: this[c];
                    ...
                    m = !0;
                    else if (c === "width" || c === "height") d = s(0, d),
                    this[c] = d,
                    ...
                    this[c] = d,
                    Da(d) && (d += "px");
                    else if (c === "dashstyle")(f.getElementsByTagName("stroke")[0] || T(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid",
                    this.dashstyle = d,
                    m = !0;
                    else if (c === "fill") if (h === "SPAN") g.color = d;
                    else {
                        if (h !== "IMG") f.filled = d !== Q ? !0 : !1,
                        d = i.color(d, f, c, this),
                        c = "fillcolor"
                    } else if (h === "shape" && c === "rotation") this[c] = d,
                    f.style.left = -u(Z(d * ab) + 1) + "px",
                    f.style.top = u(W(d * ab)) + "px";
        ...
        var fa = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    q = m.x2 || m[2] || 0,
                    m = m.y2 || m[3] || 0,
                    r = 'angle="' + (90 - K.atan((m - a) / (q - c)) * 180 / Aa) + '"',
                    u();
                    else {
                        var j = m.r,
                        E = j * 2,
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = qa(a),
                h = ["<", c, ' opacity="', f.get("a"), '"/>'],
                T(this.prepVML(h), null, null, b),
                j = f.get("rgb");
                else {
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    var f = a + c,
                    g = b + d,
                    h; ! r(e) || !e.r ? f = sa.prototype.symbols.square.apply(0, arguments) : (h = O(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                    return f
                }
            }
        };
    ...
    Qa.prototype = {
        ...
        render: function(a, b) {
            ...
            if (l && t) r === "inside" && (t = -t),
            c.opposite && (t = -t),
            g = this.getMarkPath(S, E, t, l, f, e),
            m ? m.animate({
                d: g
            ...
            if (h && !isNaN(S)) h.xy = E = this.getLabelPosition(S, E, h, f, j, u, a, v),
            this.isFirst && !n(d.showFirstLabel, 1) || this.isLast && !n(d.showLastLabel, 1) ? s = !1 : !x && f && j.overflow === "justify" && !this.handleOverflow(a, E) && (s = !1),
            v && a % v && (s = !1),
            s ? (h[this.isNew ? "attr": "animate"](E), this.isNew = !1) : h.attr("y", -9999)
        },
        destroy: function() {
            Ga(this, this.axis)
        }
    ...
    ob.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            else if (e && g >= 1E3) for (; e--&&f === A;) a = Math.pow(1E3, e + 1),
            g >= a && d[e] !== null && (f = Ja(b / a, -1) + d[e]);
        ...
        getSeriesExtremes: function() {
            ...
            function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (h = g.xData, h.length) a.dataMin = O(n(a.dataMin, h[0]), Fa(h)),
                        a.dataMax = s(n(a.dataMax, h[0]), wa(h))
                    } else {
                        ...
                        if (!a.usePercentage && v.length) a.dataMin = O(n(a.dataMin, v[0]), Fa(v)),
                        a.dataMax = s(n(a.dataMax, v[0]), wa(v));
                        if (r(o)) if (a.dataMin >= o) a.dataMin = o,
                        a.ignoreMinPadding = !0;
                        else if (a.dataMax < o) a.dataMax = o,
        ...
        setAxisTranslation: function() {
            ...
            f = this.linkedParent,
            g = this.transA;
            if (this.isXAxis) f ? (d = f.minPointOffset, e = f.pointRangePadding) : o(this.series,
            function(a) {
                var f = a.pointRange,
                ...
                b = s(b, f);
                d = s(d, g ? 0 : f / 2);
                e = s(e, g === "on" ? 0 : f); ! a.noSharedTooltip && r(k) && (c = r(c) ? O(c, k) : k)
            }),
            this.minPointOffset = d,
            this.pointRangePadding = e,
            this.pointRange = b,
        ...
        setTickPositions: function(a) {
            ...
            if (e) ! a && O(b.min, n(b.dataMin, b.min)) <= 0 && Oa(10, 1),
            b.min = da(ka(b.min)),
            b.max = da(ka(b.max));
            ...
            if (!i) i = f ? (b.getNonLinearTimeTicks || Cb)(Ab(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max),
            b.tickPositions = i;
            if (!h) e = i[0],
            f = i[i.length - 1],
            ...
            i.length === 1 && (b.min -= 1.0E-9, b.max += 1.0E-9)
        },
        ...
        render: function() {
            ...
            v,
            s;
            if (a.hasData || f) if (a.minorTickInterval && !a.categories && o(a.getMinorTickPositions(),
            function(b) {
                k[b] || (k[b] = new Qa(a, b, "minor"));
                H && k[b].isNew && k[b].render(null, !0);
                k[b].isActive = !0;
                k[b].render()
            }), g.length && o(g.slice(1).concat([g[0]]),
            function(b, c) {
                c = c === g.length - 1 ? 0 : c + 1;
                if (!f || b >= a.min && b <= a.max) j[b] || (j[b] = new Qa(a, b)),
                H && j[b].isNew && j[b].render(c, !0),
                j[b].isActive = !0,
                j[b].render(c)
            }), q && o(g,
            function(b, c) {
                if (c % 2 === 0 && b < a.max) l[b] || (l[b] = new nb(a)),
                v = b + p,
                s = g[c + 1] !== A ? g[c + 1] + p: a.max,
                l[b].options = {
                    from: e ? aa(v) : v,
                    to: e ? aa(s) : s,
                    color: q
        ...
        destroy: function() {
            ...
            for (c in b) Ga(b[c]),
            b[c] = null;
            o([a.ticks, a.minorTicks, a.alternateBands, a.plotLinesAndBands],
            function(a) {
                Ga(a)
            });
            o("stackTotalGroup,axisLine,axisGroup,gridGroup,labelGroup,axisTitle".split(","),
            function(b) {
                a[b] && (a[b] = a[b].destroy())
            })
        }
    ...
    pb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            g = h[0];
            h = h[1];
            i && (!a.series || !a.series.noSharedTooltip) ? (d.hoverPoints = a, j && o(j,
            function(a) {
                a.setState()
            }), o(a,
            function(a) {
    ...
    qb.prototype = {
        ...
        onmousemove: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                e = [];
                h = c.length;
                for (i = 0; i < h; i++) if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints && c[i].tooltipPoints.length) b = c[i].tooltipPoints[k],
                b._dist = M(k - b[c[i].xAxis.tooltipPosName || "plotX"]),
                j = O(j, b._dist),
                e.push(b);
        ...
        resetTracker: function(a) {
            ...
            d = b.hoverPoint,
            e = b.tooltip,
            b = e && e.shared ? b.hoverPoints: d; (a = a && e && b) && la(b)[0].plotX === A && (a = !1);
            if (a) e.refresh(b);
            else {
                if (d) d.onMouseOut();
                if (c) c.onMouseOut();
        ...
        setDOMEvents: function() {
            ...
            var h = function(a) {
                if (!a || !(a.touches && a.touches.length > 1)) {
                    ...
                    if (m) h < c.plotLeft ? h = c.plotLeft: h > c.plotLeft + c.plotWidth && (h = c.plotLeft + c.plotWidth),
                    l < c.plotTop ? l = c.plotTop: l > c.plotTop + c.plotHeight && (l = c.plotTop + c.plotHeight);
    ...
    rb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!t && (a.legendGroup = d.g("legend-item").attr({
                ...
                align: l ? "left": "right",
                zIndex: 2
            }).add(a.legendGroup), (x ? t: a.legendGroup).on("mouseover",
            function() {
                a.setState("hover");
            ...
            if (f && b.itemX - o + e > (m || c.chartWidth - 2 * k - o)) b.itemX = o,
        ...
        scroll: function(a, b) {
            ...
            e = -O(e * (d - 1), this.fullHeight - e + i) + 1,
    ...
    sb.prototype = {
        ...
        adjustTickAmounts: function() {
            this.options.chart.alignTicks !== !1 && o(this.axes,
            function(a) {
                a.adjustTickAmount()
            });
            this.maxTicks = null
        ...
        showLoading: function(a) {
            ...
            this.loadingSpan = T("span", null, d.labelStyle, c);
        ...
        pan: function(a) {
            ...
            c = b.translate(c + this.plotWidth - a, !0) - d; (d = this.hoverPoints) && o(d,
            function(a) {
                a.setState()
            });
        ...
        getContainer: function() {
            ...
            a || Oa(13, !0);
            c = z(w(a, "data-highcharts-chart")); ! isNaN(c) && Ha[c] && Ha[c].destroy();
        ...
        getMargins: function() {
            ...
            this.hasCartesianSeries && o(this.axes,
            function(a) {
                a.getOffset()
            });
    ...
    Ua.prototype = {
        init: function(a, b, c) {
            ...
            this.pointAttr = {};
            if (a.options.colorByPoint) b = a.chart.options.colors,
        ...
        destroyElements: function() {
            for (var a = "graphic,tracker,dataLabel,dataLabelUpper,group,connector,shadowGroup".split(","), b, c = 6; c--;) b = a[c],
        ...
        onMouseOut: function() {
            var a = this.series.chart,
            b = a.hoverPoints;
            if (!b || Ub(this, b) === -1) this.firePointEvent("mouseOut"),
            this.setState(),
            a.hoverPoint = null
        },
    ...
    P.prototype = {
        ...
        bindAxes: function() {
            ...
            c = a.chart,
            d;
            a.isCartesian && o(["xAxis", "yAxis"],
            function(e) {
                o(c[e],
                function(c) {
                    d = c.options;
                    if (b[e] === d.index || b[e] === A && d.index === 0) c.series.push(a),
                    a[e] = c,
                    c.isDirty = !0
                })
            })
        ...
        drawLegendSymbol: function(a) {
            ...
            this.legendSymbol = e.symbol(this.symbol, d / 2 - b, a - 4 - b, 2 * b, 2 * b).add(f)
        },
        ...
        setData: function(a, b) {
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                if (Da(g)) {
                    ...
                    j += d;
                    this.xIncrement = j
                } else if (Ia(g)) if (m) for (i = 0; i < l; i++) d = a[i],
                e[i] = d[0],
                k[i] = d.slice(1, m + 1);
        ...
        generatePoints: function() {
            ...
            b = this.data = b;
            for (m = 0; m < g; m++) i = h + m,
            j ? l[m] = (new f).init(this, [d[m]].concat(la(e[m]))) : (b[i] ? k = b[i] : a[i] !== A && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
        ...
        translate: function() {
            ...
            for (l = 0; l < h; l++) {
                ...
                if (c && this.visible && t && t[q]) o = t[q],
                q = o.total,
                o.cum = o = o.cum - p,
                p = o + p,
                j && (o = n(b.threshold, f.min)),
                f.isLog && o <= 0 && (o = null),
                c === "percent" && (o = q ? o * 100 / q: 0, p = q ? p * 100 / q: 0),
                k.percentage = q ? k.y * 100 / q: 0,
                k.total = k.stackTotal = q,
                k.stackY = p;
        ...
        drawPoints: function() {
            ...
            a = l.enabled && i.enabled === A || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== A && !isNaN(e)) if (a = g.pointAttr[g.selected ? "select": ""], h = a.r, i = n(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({
        ...
        destroy: function() {
            ...
            o("area,graph,dataLabelsGroup,group,markerGroup,tracker,trackerGroup".split(","),
            function(b) {
        ...
        setVisible: function(a, b) {
            ...
            this.isDirty = !0;
            this.options.stacking && o(c.series,
            function(a) {
    ...
    fa = ba(P, {
        ...
        translate: function() {
            ...
            c.grouping === !1 ? f = 1 : o(b.series,
            function(b) {
                var c = b.options;
                if (b.type === a.type && b.visible && a.options.group === c.group) c.stacking ? (k = b.stackKey, j[k] === A && (j[k] = f++), l = j[k]) : c.grouping !== !1 && (l = f++),
                b.columnIndex = l
            });
            var m = a.points,
        ...
        drawPoints: function() {
            ...
            function(e) {
                var f = e.plotY,
                g = e.graphic;
                if (f !== A && !isNaN(f) && e.y !== null) d = e.shapeArgs,
                g ? (fb(g), g.animate(B(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select": ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
    ...
    pa = {
        ...
        pointClass: ba(Ua, {
            ...
            setVisible: function(a) {
                ...
                if (!b.isDirty && b.options.ignoreHiddenPoint) b.isDirty = !0,
                c.redraw()
            },
            ...
            if (d.enabled || this._hasPointLabels) {
                ...
                for (a = p[0][0] && p[0][0].dataLabel && (p[0][0].dataLabel.getBBox().height || 21); u--;) {
                    ...
                    for (v = 0; v < C; v++) {
                        ...
                        g.moved = !0;
                        if (q && f) g = b.connector,
                        h = i ? ["M", r + (h[6] === "left" ? 5 : -5), t, "C", r, t, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5]] : ["M", r + (h[6] === "left" ? 5 : -5), t, "L", h[2], h[3], "L", h[4], h[5]],
                        g ? (g.animate({
                            d: h
