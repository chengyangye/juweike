...
function setthisone(){
	...
	//commonhtm = commonhtm + '<ul><li><a href=\"#home\">Home</a></li><li><a href=\"#news\">News</a></li><li><a href=\"#contact\">Contact</a></li><li><a href=\"#about\">About</a></li></ul>';
	if(parent.endmbxz){
...
<div style="width:320px;position:relative;height:737px;" class="ppdiv">
    <div class="nav-scontent">
        <ul id="navshow">
            <li id="nav_1" class="qq_add_parent">
                <a href="javascript:;" class="add_qq_more">
                    <span>
            ...
            <li id="nav_2" class="qq_add_parent">
                <a href="javascript:;" class="add_qq_more">
                    <span>
        ...
        <div id="navshow2" class="qq_add_parent">
...
<div style="width:320px;position:relative;height:737px;" class="ppdiv">
    <div class="nav-scontent">
        <ul id="navshow">
            ...
            <li id="nav_3" class="qq_add_parent">
                <a href="javascript:;" class="add_qq_more">
    ...
    <div class="wz_25_wrapper1">
        <div class="wz_25_content1">
            <ul>
                <a href="javascript:;" class="add_qq_more">
                    <li>
                        <button class="wz_25_buttom1" type="button"><img src="/res/wz/images/1.png" class="m_pic"><span class="m_text">11111</span></button>
                    </li>
                </a>
                <a href="javascript:;" class="add_qq_more">
                    <li>
                        <button class="wz_25_buttom1" type="button"><img src="/res/wz/images/1.png" class="m_pic"><span class="m_text">22222</span></button>
                    </li>
                </a>
                <a href="javascript:;" class="add_qq_more">
                    <li>
                        <button class="wz_25_buttom1" type="button"><img src="/res/wz/images/1.png" class="m_pic"><span class="m_text">33333</span></button>
                    </li>
                </a>
                <a href="javascript:;" class="add_qq_more">
                    <li>
                        <button class="wz_25_buttom1" type="button"><img src="/res/wz/images/1.png" class="m_pic"><span class="m_text">44444</span></button>
                    </li>
                </a>
            </ul>
        </div>
...
<div style="width:320px;position:relative;height:737px;" class="ppdiv">
    <div class="car_content">
        <ul class="nav_links qq_add_parent">
...
<div style="width: 320px;" class="ppdiv">
    <div id="mainmenu21">
        <div class="menu21N">
            <div class="firstmenu qq_add_parent">
                <a href="javascript:;" class="add_qq_more">
                    <div class="nr21main">
...
<td align="center" valign="top" rel="0">
<div style="width: 320px;" class="ppdiv">
    <div class="mainmenu46 qq_add_parent">
...
<div style="width:320px;position:relative;height:737px;" class="ppdiv">
    <div id="cate23">
        ...
        <div class="catemenu qq_add_parent">
            <a href="javascript:;" class="add_qq_more">
...
<td align="center" valign="top" rel="2">
<div style="width: 320px;" class="ppdiv">
    <div style="border-bottom:1px solid #cecfcf;" class="qq_add_parent">
...
<div style="width: 320px;" class="ppdiv">
    <div class="content_main">
        <ul class="index_listintro">
            <li class="add_qq_more">
                <a href="javascript:;"><img src="/res/wz/images/icon_loupantupian_72x72.png" class="m_pic"/><h2 class="m_text">新闻动态</h2> </a>
            </li>
            <li class="add_qq_more">
                <a href="javascript:;"><img src="/res/wz/images/icon_loupantupian_72x72.png" class="m_pic"/> <h2 class="m_text">新闻动态</h2> </a>
            </li>
            ...
            <li class="add_qq_more">
                <a href="javascript:;"> 
                    <img src="/res/wz/images/icon_loupantupian_72x72.png" class="m_pic"/>
                    <p class="m_text">新闻动态</p>
                    <span></span>
                </a>
            </li>
    ...
    <div id="mainmenu155">
        <ul>
            <li class="add_qq_more">
                <a href="javascript:;">
                    <img src="/res/wz/images/cover10.jpg" class="m_pic">
                    <div class="text-cont bgcolor" style="height:50px;">
                        <p class="title m_text">XXXXX</p>
                    </div>
                </a>
            </li>
    ...
    <div id="cate60">
        <ul class="mainmenu60">
            <li class="add_qq_more">
                <div class="menubtn60">
                    <a href="javascript:;">
                        <div class="menumesg60">
                        <div class="menuimg60"><img src="/res/wz/images/car-list.png" class="m_pic"/></div>
                            <div class="menutitle60 m_text">最新活动</div>
                        </div>
                    </a>
                </div>
            </li>
...
<td align="center" valign="top" rel="0">
<div style="width: 320px;" class="ppdiv">
    <div class="mainmenu61" fixed="fixed">
        <ul>
            <li class="add_qq_more">
                <div class="menubtn61">
                    <a href="javascript:;" class="m_text">新闻动态</a>
                </div>
            </li>
            <li class="add_qq_more">
                <div class="menubtn61">
                    <a href="javascript:;" class="m_text">最新活动</a>
                </div>
            </li>
            <li class="add_qq_more">
                <div class="menubtn61">
                    <a href="javascript:;" class="m_text">最新朋友聚会照片</a>
                </div>
            </li>
            <li class="add_qq_more">
                <div class="menubtn61">
                    <a href="javascript:;" class="m_text">最新家人聚会照片</a>
                </div>
            </li>
            <div class="clr"></div>
        </ul>    
...
<td align="center" valign="top" rel="0">
<div style="width: 320px;" class="ppdiv">
    <div class="mainmenu62">
    <div class="cate-item l0 left black-font qq_add_parent
" style="height: 178px;">
        <a class="add_qq_more" href="javascript:;">
            <div class="list-img"><img src="/res/wz/images/tupian62.jpg" class="m_pic" style="width:100%;height:178px;"></div>
            <div class="cate-text" style="height:178px;">
                <span class="cate-name m_text" style="color:#333;">特优惠团购(晚餐)</span>
                <span class="cate-desc m_desc" style="color:#333;">仅95元，享价值128元精美单人自助晚餐！各式冷盘、情调西餐、地道中餐、特色日式、精致甜点...周六周日可使用！</span>
            </div>
        </a>
    </div>
    <div class="cate-item l0 left l1 white-font right qq_add_parent
" style="height: 178px;">
        <a class="add_qq_more" href="javascript:;">
            <div class="list-img"><img src="/res/wz/images/tupian62.jpg" class="m_pic" style="width:100%;height:178px;"></div>
            <div class="cate-text" style="height: 178px;">
                <span class="cate-name m_text">特优惠团购(午餐)</span>
                <span class="cate-desc m_desc">仅85元，享价值118元精美单人自助午餐！各式冷盘、情调西餐、地道中餐、特色日式、精致甜点...周六周日可使用！<br></span>
            </div>
        </a>
    </div>
    <div class="cate-item l0 left l2 white-font qq_add_parent
" style="height: 178px;">
        <a class="add_qq_more" href="javascript:;">
            <div class="list-img"><img src="/res/wz/images/tupian62.jpg" class="m_pic" style="width:100%;height:178px;"></div>
            <div class="cate-text" style="height: 178px;">
                <span class="cate-name m_text">秒殺商品</span>
                <span class="cate-desc m_desc">每天限量提供最优惠秒杀商品,不敢置信的低价!!!2014.02.08中午12:00开始</span>
            </div>
        </a>
    </div>
</div>
...
<div style="width: 320px;" class="ppdiv">
    <div class="bodyDivbg">
        <div class="bodyDiv">
            <div class="gwDiv add_qq_more" style="width:320px; margin:0px auto; margin-top:5px; margin-bottom:5px;">
                <a href="javascript:;"><div class="gw1 m_text" style="width:100%; background-color:#6CB248; color:#FFF">服务热线：XXXXXXXXXX</div></a>
            </div>
            <div style="clear:both"></div>
            <div class="hotpro qq_add_parent">
                <div class="hotclass add_qq_more" style="margin-left:3px"> <a href="javascript:;"><img src="/res/wz/images/flowers.jpg" border="0" style="border:1px #CFCFCF solid" width="100" class="m_pic"></a> </div>
                <div class="hotclass add_qq_more"> <a href="javascript:;"><img src="/res/wz/images/flowers.jpg" border="0" style="border:1px #CFCFCF solid" width="100" class="m_pic"></a> </div>
                <div class="hotclass add_qq_more"> <a href="javascript:;"><img src="/res/wz/images/flowers.jpg" border="0" style="border:1px #CFCFCF solid" width="100" class="m_pic"></a> </div>
            </div>
            <div style="height:1px; line-height:1px; clear:both; width:300px; font-size:1px; margin:0px auto"></div>
            <div class="menuDiv add_qq_more" style=" width:320px">
                <a href="javascript:;">
                    <div class="ml">
                        <div class="list_flag m_text">A</div>
                    </div>
                    <div class="mc m_desc">生日快乐 Happy birthday</div>
                    <div class="mr"><img src="/res/wz/images/li_r.jpg" height="35" class="m_pic"></div>
                </a>
            </div>
            <div class="clear"></div>
            <div class="menuDiv add_qq_more" style=" width:320px">
                <a href="javascript:;">
                    <div class="ml">
                        <div class="list_flag m_text">B</div>
                    </div>
                    <div class="mc m_desc">浪漫爱情 Romantic love</div>
                    <div class="mr"><img src="/res/wz/images/li_r.jpg" height="35" class="m_pic"></div>
                </a>
            </div>
            <div class="clear"></div>
            <div class="menuDiv add_qq_more" style=" width:320px">
                <a href="javascript:;">
                    <div class="ml">
                        <div class="list_flag m_text">C</div>
                    </div>
                    <div class="mc m_desc">慰问祝福 Sympathy blessing</div>
                    <div class="mr"><img src="/res/wz/images/li_r.jpg" height="35" class="m_pic"></div>
                </a>
            </div>
            <div class="clear"></div>
            <div class="menuDiv add_qq_more" style=" width:320px">
                <a href="javascript:;">
                    <div class="ml">
                        <div class="list_flag m_text">D</div>
                    </div>
                    <div class="mc m_desc">生日蛋糕 Birthday cake</div>
                    <div class="mr"><img src="/res/wz/images/li_r.jpg" height="35" class="m_pic"></div>
                </a>
            </div>
            <div class="clear"></div>
            <div class="menuDiv add_qq_more" style=" width:320px">
                <a href="javascript:;">
                    <div class="ml">
                        <div class="list_flag m_text">E</div>
                    </div>
                    <div class="mc m_desc">情侣蛋糕 Lovers cake</div>
                    <div class="mr"><img src="/res/wz/images/li_r.jpg" height="35" class="m_pic"></div>
                </a>
            </div>
            <div class="clear"></div>
            <div class="menuDiv add_qq_more" style=" width:320px">
                <a href="javascript:;">
                    <div class="ml">
                        <div class="list_flag m_text">F</div>
                    </div>
                    <div class="mc m_desc">祝寿蛋糕 Blessing cake</div>
                    <div class="mr"><img src="/res/wz/images/li_r.jpg" height="35" class="m_pic"></div>
                </a>
            </div>
            <div class="clear"></div>
            <div class="menuDiv add_qq_more" style=" width:320px">
                <a href="javascript:;">
                    <div class="ml">
                        <div class="list_flag m_text">G</div>
                    </div>
                    <div class="mc m_desc">红酒礼品 Wine Gifts</div>
                    <div class="mr"><img src="/res/wz/images/li_r.jpg" height="35" class="m_pic"></div>
                </a>
            </div>
            <div class="clear"></div>
        ...
        <div class="gwDiv add_qq_more" style="width:306px; margin:0px auto; margin-top:5px; margin-bottom:5px;">
            <a href="javascript:;"><div class="gw1 m_text" style="width:100%; background-color:#6CB248; color:#FFF">情人节热卖产品</div></a>
        </div>
        <div style="clear:both"></div>
        <div class="listDiv">
            <ul class="listul qq_add_parent">
                <li class="add_qq_more">
                    <a href="javascript:;">
                        <div class="prodiv">
                            <div class="imgdiv"><img src="/res/wz/images/flowers.jpg" class="m_pic"></div>
                            <div class="proprice m_text"> ¥188 </div>
                            <div class="proname m_desc">情人节快乐</div>
                        </div>
                    </a>
                </li>
                <li class="add_qq_more">
                ...
                <li class="add_qq_more" style=" margin-right:0px">
                    <a href="javascript:;">
                        <div class="prodiv">
                            <div class="imgdiv"><img src="/res/wz/images/flowers.jpg" class="m_pic"></div>
                            <div class="proprice m_text"> ¥188 </div>
        ...
        <div class="gwDiv add_qq_more" style="width:306px; margin:0px auto; margin-top:5px; margin-bottom:20px;">
            <a href="javascript:;"><div class="gw1 m_text" style="width:100%; background-color:#6CB248; color:#FFF">更多产品</div></a>
        </div>
        <div style="clear:both"></div>
        <div style="height:5px;line-height:5px;clear:both;"></div>
        <div id="cate63" fixed="fixed">
            <div class="imgmenu">
                <ul> 
                    <li class="add_qq_more">
                        <a href="javascript:;">
                            <img src="/res/wz/images/footer30.png" class="m_pic">
                            <p class="m_text">公司简介</p>
                        </a>
                    </li>
                    <li class="add_qq_more">
...
<div style="width: 320px;" class="ppdiv">
    <div class="content-body">
        <div class="custom-title add_qq_more">
            <a href="javascript:;"><h2 class="title m_text">最热</h2></a>
        </div>
        <ul class="custom-goods qq_add_parent">
            <li class="custom-goods-small add_qq_more">
                <a href="javascript:;" class="custom-link" target="_blank">
                    <img class="custom-image m_pic" src="/res/wz/images/sp.jpg" style="display: block;">
                    <div class="custom-notitle">
                        <em class="custom-price m_text">9499.05</em>
                    </div>
                </a>
            </li>
            <li class="custom-goods-small add_qq_more">
        ...
        <div class="custom64 qq_add_parent">
            <div class="custom-paginations">
                <a href="javascript:;" class="custom-paginations-prev disabled add_qq_more"><span class="m_text">上一页</span></a>
                <a href="javascript:;" class="custom-paginations-next js-no-follow add_qq_more"><span class="m_text">下一页</span></a>
            </div>
        </div>
    </div>
</div>
