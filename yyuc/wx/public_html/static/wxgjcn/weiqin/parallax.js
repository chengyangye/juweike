...
function boxGoIn_3() {
	...
	/*var aJson = [{left: 525, top:201, opacity: 1},
		...
		{left: 464, opacity: 1}*/
		var aJson = [{left: 495, top:181, opacity: 1},
		{left: 1150, top:181, opacity: 1},
		{left: 1150, opacity: 1},
		{left: 1150, top:443, opacity: 1},
		{left: 495, top:443, opacity: 1},
		{left: 495, opacity: 1},
		{left: 822, top:181, opacity: 1},
		{left: 822, top:443, opacity: 1},
		{left: 822, top:312, opacity: 1}
	];
...
function boxGoOut_3() {
	...
	// 	{left: 139, opacity: 0}
	// ];
	var aJson = [{left: 640, top: 255, opacity: 0},
		{left: 933, top: 255, opacity: 0},
		{left: 933, opacity: 0},
		{left: 933, top: 333, opacity: 0},
		{left: 640, top: 333, opacity: 0},
		{left: 640, opacity: 0},
        {left: 826, top: 255, opacity: 0},
        {left: 826, top: 333, opacity: 0},
        {left: 826, opacity: 0},
	];
...
var loadImg = {
//	path: './resource/skin/images/',
    path: './static/wxgjcn/weiqin/',
	imgs: {
