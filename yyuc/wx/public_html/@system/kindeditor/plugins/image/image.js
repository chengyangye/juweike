...
KindEditor.plugin('image', function(K) {
	var self = this, name = 'image',
		...
		uploadJson = K.undef(self.uploadJson, '/@system/kindeditor/uploadjson-image.html'),
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<input type="text" id="keUrl" class="ke-input-text" name="url" value="" style="width:180px;" /> &nbsp;',
			'<span class="ke-button-common ke-button-outer"  >',
			'<input type="button" id="addextpicsel" style="display:none;" class="ke-button-common ke-button" value="选择图片" onclick="picdealplug(this)"/>',
			'</span>',
			'<span class="ke-button-common ke-button-outer">',
		...
		var extbtn = K('#addextpicsel', div);
		if(window.picdealplug){
			extbtn.show();
		}
