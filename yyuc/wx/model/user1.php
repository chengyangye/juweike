...
class User1 extends Model {
	...
	*/
	function __construct($postid=''){
		parent::__construct('user',$postid);		
	}
	...
	*/
	public function validate(){
		...
		$this->val_min_length('un', 2,'帐号长度不能小于2个字符！');
