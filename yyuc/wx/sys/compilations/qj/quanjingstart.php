...
<html>
    <head>
        ...
        <title>户型全景</title><script type="text/javascript">var yyuc_jspath = "/@system/";</script><script type="text/javascript" src="/@system/js/jquery.js"></script><script type="text/javascript" src="/@system/js/yyucadapter.js"></script>
...
<div class="view_select" style="min-height: 150px; overflow-y: scroll; padding-top: 0px; margin-top: 20px; opacity: 1.02; margin-bottom: 20px;">
    ...
    <?php $__i=0; foreach ((array)$qres as $q) { $__i++; ?>
        ...
        <ul style="margin-left: 45px;">
            <li>
                <a href="quanjing-<?php echo $q->id; ?>.html"><?php echo $q->ms; ?></a>
            </li>
        </ul>
     <?php } ?>
    </div>
...
<div class="view_house" style="opacity: 1.02;"><a id="currPlace" href="javascript:void(0);"><?php echo "技术支持"; ?>-<?php echo "聚微客"; ?></a></div>
