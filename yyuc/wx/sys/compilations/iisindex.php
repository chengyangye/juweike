...
<head>
    ...
    <base href="http://wx.zongyangtech.cn/">
    <link rel="stylesheet" type="text/css" href="/res/index/weixin.css" media="all" />

<TITLE><?php echo $_SERVER['WEB_NAME']; ?>—国内领先的微信公众服务平台</TITLE>
...
<div class="topnav" style="position: relative;">
        	...
        	<div style="position: absolute;right: 51px;cursor: pointer;">
...
<script type="text/javascript">
 ...
 function checkEmail(){
	 ...
	 //if (value  && value.match(/^[\w\.\-]+@([\w\-]+\.)+[a-z]24$/ig)){
	 if (value){
		 input_correct(email);
...
<div id="container banner">
	...
	<div id="login_panel">
		<div class="window">
		<form id="loginform" action="http://wx.zongyangtech.cn/" class="fn-clear" method="post">
					<div id="panel">
								<div class="title">
				...
				<div class="first">
					<div class="inputlist" style="position:relative;">
						...
						<input type="text"   value="" name="fT08d9e827ffbba2efe4413cb064bbf847un" id="fun" class="" style="outline: 0;" placeholder="请输入用户名" tabindex="1" maxlength="40"/>						</p>
					</div>
					<div class="inputlist">
						...
						<input type="password"   value="" name="fT08d9e827ffbba2efe4413cb064bbf847pwd" id="fpwd" class="" placeholder="请输入密码" maxlength="30" style="outline: 0;"/>						</p>
					</div>
					<div>
...
<div id="about" class="footer"  data-connect="nav">
		<dl>
        	<dt>关于我们</dt>
            <dd>
<!--            	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上海XXXXX信息技术股份有限公司（聚微客，股票代码：100189）成立于2003年，注册资金：1000万，是一家专注于移动互联网业务的高新技术企业，是山东省首批5家新三板上市公司之一。
            	<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;公司有近260名员工， 17项知识产权，在各地开设9家分公司和办事处，并开拓遍布电商、CRM、ERP、L连锁、金融、零售、汽车、房产、医疗等多个行业的数万家企业客户。
             	...
             	<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;聚微客与中国移动、中国联通、中国网通、中国电信有着丰富的合作经验，并先后获得了由中华人民共和国信息产业部颁发的“中华人民共和国增值电信业务经营许可证”、“中华人民共和国电信与信息服务业务经营许可证”和由信产部批准的全国四网合一短消息类服。</p>	
 -->
         		<p>更详细的了解我们，或申请试用，请拨打咨询热线：18621784057 ，或者直接在线申请。</p>
        		 <a href="/reg.html" target="_blank" class="bottom"><img src="http://wx.zongyangtech.cn/res/index/img/weimob_10.jpg" height="37" width="135"></a>
            </dd>
...
<ul><li class="li-tit">快速入门</li>
  ...
  <li><em class="w1"></em><A class=sina href="http://e.weibo.com/cainiaoapp" target=_blank>新浪微博</A></li>
  <li><em class="w2"></em><A class=tenx href="http://e.t.qq.com/cainiaoapp" target=_blank>腾讯微博</A></li>
  <li><em class="w3"></em><A class=qq href="http://e.t.sohu.com/cainiaoapp" target=_blank>搜狐微博</A></li></ul>
...
<div class="m-two">友情链接: <a target="_blank" href="http://wx.zongyangtech.cn/"><?php echo $_SERVER['WEB_NAME']; ?></a>
                    <a target="_blank" href="http://www.cainiaoapp.cn/">企业APP</a></div>
