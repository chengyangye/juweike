			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span12">
								<h3><i class="icon-cog"></i>添加装修相册</h3>
							</div>
						</div>
						<div class="box-content">
							<form action="" method="post" class="form-horizontal form-validate" id="transform"><?php echo tk();  echo $album->hidden('id'); ?>
								<div class="control-group">
									<label for="title" class="control-label">相册名称：</label>
									<div class="controls">
									 <?php echo $album->text('name','class="input-large"  required="required"'); ?>
								...
								<div class="control-group">
									...
									<div class="controls">
										<?php echo $album->text('sort','class="input-large"  required="required"'); ?>
										<span class="maroon">*</span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<?php echo $album->textarea('jianjie','class="input-large" required="required" style="height:80px;width:380px;"'); ?>
										<span class="maroon">*</span>
...
<script>		
		...
		$(function(){
			$('#transform').submit(function(){
				...
				$('#micro_zhuangxiu_albumpic').val($.toJSON(pics));
			});
			var val = $('#micro_zhuangxiu_albumpic').val();
			if($.trim(val)==''){
				val = '[]';
			}
