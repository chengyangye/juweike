            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3><i class="icon-table"></i>车型管理</h3>
                            </div>
                        ...
                        <div class="box-content">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12 control-group">
                                    <a href="chexingadd.html" class="btn" id="add_menu"><i class="icon-plus"></i>添加车型</a> 
                                      <div class="btn-group datatabletool">
                                       <a class="btn" title="删除" onclick="dellbs('chexing','a',this);"><i class="icon-trash"></i></a>
                                    </div>
                                </div>
                                ...
                                <table id="listTable" class="table table-bordered table-hover dataTable">
                                    ...
                                    <thead>
									   ...
									   <?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>     
                                        ...
                                        <td><?php echo $r->nk; ?>/<?php echo $r->name; ?></td>
                                        <td><?php echo $pinpai_arr[$r->ppid]; ?>/<?php echo $chexi_arr[$r->pid]; ?></td>
                                         <td><?php echo $r->bj; ?>万元</td>
                                        <td><?php echo $r->sort; ?></td>
                                        <td class="input-medium">
											<a href="chexingfullview-<?php echo '1'; ?>-<?php echo $r->id; ?>.html" class="btn">管理全景图</a>
                                            <a class="btn" href="chexingadd-<?php echo $r->id; ?>.html" title="编辑"><i class="icon-edit"></i></a>
                                            <a class="btn" href="javascript:void(0);" title="删除" onclick="dellbs('chexing',<?php echo $r->id; ?>,this);"><i class="icon-remove"></i></a></td>
                                    </tr>
									       <?php } ?>    
                                     </table>
