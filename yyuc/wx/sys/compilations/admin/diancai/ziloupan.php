				...
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3>
									<i class="icon-table"></i>菜品分类管理
									<small>如果您的餐厅内部有多个菜系，请在此添加，如果没有可以不添加。</small>
								</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="ziloupanadd.html" class="btn"><i class="icon-plus"></i>添加菜品分类</a>
								</div>
								<div class="span4" style="text-align:right;">
									<form action="" class="form-horizontal form-validate">
										<?php echo $tj->text('name','class="input-large" placeholder="请输入菜品分类名称" '); ?>
							...
							<div class="row-fluid dataTables_wrapper">
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											<th class="span4">菜品分类名称</th>
											<th class="span4">菜品分类描述</th>
