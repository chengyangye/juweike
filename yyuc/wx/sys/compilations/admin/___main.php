...
<body class="<?php echo Session::get('maintheme'); ?>">
    ...
    <div class="container-fluid" id="content">
        ...
        <div class="right">
            <div class="main">
                <iframe frameborder="0" id="mainFrame" name="mainFrame" src="/admin/userCenter/welcom.html" style="background: url('http://stc.weimob.com/img/loading.gif') center no-repeat"></iframe>
            </div>
        </div>
