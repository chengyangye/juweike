...
<title>幸运机设定</title><script type="text/javascript">var yyuc_jspath = "/@system/";</script><script type="text/javascript" src="/@system/js/jquery.js"></script><script type="text/javascript" src="/@system/js/yyucadapter.js"></script>
...
<body>
	...
	<div class="alert alert-info">
	  	<p><span class="bold">说明：</span>幸运机是一种游戏促销模式。</p>
	  	<p><span class="bold">当前地址：</span><?php echo getUrl('xyj'); ?></p>
	</div>
	<form class="form-horizontal" id="lbsForm" action="" method="post"><?php echo tk();  echo $lbs->hidden('id'); ?>
		<div class="control-group">
	    	<label class="control-label" for="keyword">幸运机名称</label>
	    	<div class="controls">
