...
<title><?php echo $_SERVER['WEB_NAME']; ?>—领先的微信公众服务平台</title><script type="text/javascript">var yyuc_jspath = "/@system/";</script><script type="text/javascript" src="/@system/js/jquery.js"></script><script type="text/javascript" src="/@system/js/yyucadapter.js"></script>
					...
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" id="transform" class="form-horizontal form-validate"><?php echo tk();  echo $m->hidden('id'); ?>
								...
								<div class="control-group">
									<label for="area" class="control-label">会员服务描述：</label>
									<div class="controls">
...
<script>		
		...
		$(function(){
			$('#transform').submit(function(){
				...
				$('#micro_shipin_typepic').val($.toJSON(pics));
			});
			var val = $('#micro_shipin_typepic').val();
			if($.trim(val)==''){
				val = '[]';
			}
