...
<title>自定义菜单</title><script type="text/javascript">var yyuc_jspath = "/@system/";</script><script type="text/javascript" src="/@system/js/jquery.js"></script><script type="text/javascript" src="/@system/js/yyucadapter.js"></script>
<style>
body{
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$wtpres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
						<td>
						<?php echo $r->name; ?>
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$wdyres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$wtgres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$whykres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$xyjres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$yzddres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$xydzpres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$ggkres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$yhqres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$wyyres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$dtwres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r['id']; ?>">
						</td>
...
<table class="table table-bordered">
						...
						<?php $__i=0; foreach ((array)$ddtwres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r['id']; ?>">
						</td>
