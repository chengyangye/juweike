...
<body>
	<div class="main-title">
		<h3>我的微官网:<sub style="color: gray;"><?php echo $mywwz; ?>/<span id="yemianpage">index</span>.html</sub></sub>&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 -->  
	...
	<table class="table table-bordered">
    	...
    	<td><img src="/res/fmdtp.jpg"/></td>
					...
					<tr id="t_txt" rel="m_txt">
					<td style="border: none;" colspan="2"><?php echo $m->texteditor('txt','langType:"zh-cn",allowImageUpload:false,allowFlashUpload:true,allowMediaUpload:false,allowFileManager:false,items:kindeditor_item3,afterChange:setwbdnr','325px','200px'); ?></td>
					</tr>
