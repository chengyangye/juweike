            ...
            <div class="msg_inner_wrapper default_box news_box">
                <div class="msg_item multi_news">
                    <div class="sub_msg_list add_qq_more">
                        <a class="sub_msg_item" href="javascript:;"><span class="thumb"><img src="/res/wz/images/weizi01.jpg"  class="m_pic" width="70px" class="m_pic"></span><h4 class="msg_title m_text">此处为内容展示标题</h4></a>
                    </div>
                    <div class="sub_msg_list add_qq_more">
                        <a class="sub_msg_item" href="javascript:;"><span class="thumb"><img src="/res/wz/images/weizi01.jpg"  class="m_pic" width="70px" class="m_pic"></span><h4 class="msg_title m_text">此处为内容展示标题</h4></a>
                    </div>
...
<div style="width:320px;position:relative;height:737px;" class="ppdiv">
    <div id="cate23">
        ...
        <div class="catemenu">
            ...
            <ul>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text">功匠工房实木</span></a>
                </li>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text">乔蒂亚印尼街</span></a>
                </li>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text">新悦板木家具</span></a>
                </li>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text">玛润奇家具</span></a>
                </li>
            </ul>
        </div>
        <div class="catemenu">
        ...
        <div class="catemenu">
            ...
            <ul>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text">杜莎美式家具</span></a>
                </li>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text">愉悦玫瑰</span></a>
                </li>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text">艺家百年韩式</span></a>
                </li>
                <li class="add_qq_more">
                    <a href="javascript:;"><span class="m_text"><font color="red">更多...</font></span></a>
                </li>
            </ul>
        </div>
        <div class="catemenu">
...
<button style="position: fixed; left: 280px; z-index:811202;bottom:10px;padding: 5px 12px 5px 12px;font-weight: bold;" onclick="selthis()">确定选择</button>
<script type="text/javascript">
$(function(){
	$('#mainxztr').children('td').click(function(){
		$('#mainxztr').children('td').unmask();
		$(this).mask('选择此模板');
		window.xzdmb = this;
	});
});
...
function selthis(){
	...
	parent.endmbxz($(window.xzdmb).find('.ppdiv').html());
	parent.yyucpopclose();
}
</script>
