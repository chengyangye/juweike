...
<div>
<form action="microVoteList-<?php echo $lbs->id; ?>.html">
手机号：
	...
	<table class="table table-bordered">
			...
			<?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>			 
			      <tr>
						...
						<td>
						<?php if ($r->ans == 1){  echo $lbs->option1; ?>
						<?php }elseif ($r->ans == 2 ){  echo $lbs->option2; ?>
						<?php }elseif ($r->ans == 3 ){  echo $lbs->option3; ?>
						<?php }elseif ($r->ans == 4 ){  echo $lbs->option4; ?>
						<?php } ?>
						</td>
					<!-- 	<td></td> -->
				  </tr>
