							...
							<form action="" method="post" class="form-horizontal form-validate"><?php echo tk();  echo $full_view->hidden('id'); ?>
								...
								<div class="control-group">
									...
									<?php echo $full_view->hidden('pic_qian'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_qian','micro_hunqing_type_full_viewpic_qian');">选择图片</button>
								...
								<div class="control-group">
									...
									<?php echo $full_view->hidden('pic_hou'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_hou','micro_hunqing_type_full_viewpic_hou');">选择图片</button>
											<span class="help-inline">建议尺寸：宽700像素，高700像素</span>
										</span>
									</div>
								</div>
								<div class="control-group">
									...
									<?php echo $full_view->hidden('pic_zuo'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_zuo','micro_hunqing_type_full_viewpic_zuo');">选择图片</button>
											<span class="help-inline">建议尺寸：宽700像素，高700像素</span>
										</span>
									</div>
								</div>
								<div class="control-group">
									...
									<?php echo $full_view->hidden('pic_you'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_you','micro_hunqing_type_full_viewpic_you');">选择图片</button>
											<span class="help-inline">建议尺寸：宽700像素，高700像素</span>
										</span>
									</div>
								</div>
								<div class="control-group">
									...
									<?php echo $full_view->hidden('pic_shang'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_shang','micro_hunqing_type_full_viewpic_shang');">选择图片</button>
											<span class="help-inline">建议尺寸：宽700像素，高700像素</span>
										</span>
									</div>
								</div>
								<div class="control-group">
									...
									<?php echo $full_view->hidden('pic_xia'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_xia','micro_hunqing_type_full_viewpic_xia');">选择图片</button>
											<span class="help-inline">建议尺寸：宽700像素，高700像素</span>
										</span>
									</div>
								</div>
