					...
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" class="form-horizontal form-validate"><?php echo tk();  echo $m->hidden('id'); ?>
								...
								<div class="control-group">
									<label for="position" class="control-label">客户职位：</label>
									<div class="controls">
								...
								<div class="control-group">
									<label class="control-label">客户照片：</label>
									<div class="controls">
										<img class="thumb_img" src="<?php echo $m->pic; ?>" id="pic" style="max-height:100px;" />
										<?php echo $m->hidden('pic'); ?>
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic','micro_hunqing_expert_commentpic');">选择图片</button>
								...
								<div class="control-group">
									<label for="description" class="control-label">客户介绍：</label>
									<div class="controls">
