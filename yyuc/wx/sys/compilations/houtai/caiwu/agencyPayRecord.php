...
<div class="content-box role">
	<div class="content-box-header">
		<h3>当前登录角色：<?php echo $user_role; ?>, 累计充值总金额:<?php echo $payTotal; ?>,累计到账总金额:<?php echo $payRelTotal; ?></h3>
		<div class="clear"></div>
	</div>
	<div class="content-box-content">
		<div class="default-tab" >
		    ...
		    <label>代理账号</label><?php echo $tj->text('aun'); ?>
		    <?php if ($mu->isadmin|| $mu->isyg){ ?>
		    <label>代理类型</label><?php echo $tj->select($agency_type,'atype'); ?>
		    <?php } ?>
		    <br/>
