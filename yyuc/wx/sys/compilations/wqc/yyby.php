...
<!--				<li class="nob">
					<table class="kuang" border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody><tr>
							<th>品牌</th>
							<td class="userinfo" id="price1"><?php echo $pp->name; ?></td>
						</tr>
					</tbody></table>
				</li>
				<li class="nob">
					<table class="kuang" border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody><tr>
							<th>车系</th>
							<td class="userinfo" id="price1"><?php echo $cx->name; ?></td>
						</tr>
					</tbody></table>
				</li>
				<li class="nob">
					<table class="kuang" border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody><tr>
							<th>车型</th>
							<td class="userinfo" id="price1"><?php echo $c->name; ?></td>
						</tr>
					</tbody></table>
				</li>
				<li class="nob">
					<table class="kuang" border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody><tr>
							<th>车牌</th>
							<td class="userinfo" id="price1"><?php echo $mc->cpai; ?></td>
						</tr>
					</tbody></table>
				</li>	-->
...
/*    			var ctj = true;
    			...
    			$.ajax({
    			url:'yybyok-<?php echo $h->id; ?>-<?php echo $cx->id; ?>-<?php echo $r->id; ?>.html',
