...
<div class="pop_tips" id="popTips" style="display:none;">
	<div class="pop_show">
		...
		<div class="pop_info">
			...
			<input id="inputImpress" maxlength="4" type="text" class="input_impress" placeholder="输入四个字的美容印象" />
		</div>
		<div class="pop_btns">
