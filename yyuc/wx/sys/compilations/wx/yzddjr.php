...
<body>
<div class="wrapper">
    <img class="bg" src="/res/yzdd/images/bg_reading.png">
    <div class="desc-cont1">
        <img class="bg" src="/res/yzdd/images/bg_reading_2.png">
		<button class="next-btn start1" onclick="location.href='yzddkz-<?php echo $yid; ?>.html'">开始答题</button>
		<div class="start-text">赛事进入第<?php echo ($yjts+1); ?>天<br>祝您马到成功!</div>
	</div>
</div>
</body>
</html>