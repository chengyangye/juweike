...
class Model extends SampleModel{
	...
	public function find($id=null,$pam=null){
		...
		if($id === null){
			$fillok = $this->YYUCSYS_db->fill_one_model($this,$this->YYUCSYS_condition,null,$this->YYUCSYS_order,'1');
		}elseif(is_array($id)||$pam!==null){
			$fillok = $this->YYUCSYS_db->fill_one_model($this,$id,$pam,$this->YYUCSYS_order,'1');
		}else{
	...
	public function list_all($condition=null,$pam=null){
		...
		if(is_array($condition)){
			return $this->YYUCSYS_db->fill_models($this,$condition,$this->YYUCSYS_order,$this->YYUCSYS_limit,$this->YYUCSYS_select);	
		}else if (is_string($condition)){
			return $this->YYUCSYS_db->fill_models($this,$condition,$this->YYUCSYS_order,$this->YYUCSYS_limit,$this->YYUCSYS_select,$pam);	
		}else {
			return $this->YYUCSYS_db->fill_models($this,$this->YYUCSYS_condition,$this->YYUCSYS_order,$this->YYUCSYS_limit,$this->YYUCSYS_select,$this->YYUCSYS_pam);
		}
	}
	...
	public function list_all_array($condition=null,$pam=null){
		DBDes::init_by_model($this,'R');
		if(is_array($condition)){
			return $this->YYUCSYS_db->fill_models_array($this,$condition,$this->YYUCSYS_order,$this->YYUCSYS_limit,$this->YYUCSYS_select);	
		}else if (is_string($condition)){
			return $this->YYUCSYS_db->fill_models_array($this,$condition,$this->YYUCSYS_order,$this->YYUCSYS_limit,$this->YYUCSYS_select,$pam);	
		}else {
			return $this->YYUCSYS_db->fill_models_array($this,$this->YYUCSYS_condition,$this->YYUCSYS_order,$this->YYUCSYS_limit,$this->YYUCSYS_select,$this->YYUCSYS_pam);
		}
	}
	 ...
	 * @return array 一键多值数组
	 */
	function map_array_allres($field1,$field='*'){
		if($field=='*'){
			$field = $this->YYUCSYS_real_tablename.'.*';
		}
		DBDes::init_by_model($this,'R');
		$sql = $this->YYUCSYS_db->com_sql($this->YYUCSYS_real_tablename,$this->YYUCSYS_condition,$this->YYUCSYS_order,$this->YYUCSYS_limit,"`$field1` as k,".$field." ",$this->YYUCSYS_pam);
		$res = $this->YYUCSYS_db->query($sql);
		$res_arr = array();
		foreach ($res as $arr){
	 ...
	 * @return integer 平均值
	 */
	function avg($field,$condition=null,$pam=null){
		if($condition===null){
