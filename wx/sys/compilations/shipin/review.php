...
<div class="wrapper">
	<!-- start -->
		<ul class="nav_top" id="navTop" style="display:none;">
			...
			<li><a href="javascript:void(0);" onclick="REVIEW.switchPanel(1);return false;">点评</a></li>
		</ul>
	<!-- end -->
...
<div class="pop_tips" id="popTips" style="display:none;">
	<div class="pop_show">
		...
		<div class="pop_info">
			...
			<input id="inputImpress" maxlength="4" type="text" class="input_impress" placeholder="输入四个字的食品印象" />
		</div>
		<div class="pop_btns">
