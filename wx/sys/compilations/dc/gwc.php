...
</head><body id="mymenu" style=""><div class="window" id="windowcenter">
...
function gotoorder(){
window.location.href='http://www.apiwx.com/?ac=diancaionline-list&c=o7MB9jtCnCf1wLBxlADC4kcO02Io&shopid=1&id=650';
}
...
//goodsData+=goodsList[i].name+','+goodsList[i].specId+','+goodsList[i].number+';';
            }
 
            g('goodsData').value = goodsData;
 
document.getElementById('captch').value = document.getElementById("totalPrice").innerHTML;
...
<div class="header">
        ...
        <label><i>共计：</i><b id="totalPrice" class="duiqi">0.00</b><b class="duiqi">元</b></label>
</div>

<div class="biaodan">
            <h2>我的订单
                <button id="clearBtn" class="btn_add emptyIt" onclick="clearCache();">清空</button>
               <a href="<?php echo "dc-".Request::get('1')."-1.html?wxid=".$_GET['wxid']."#";?>mp.weixin.qq.com"> <button class="btn_add">继续点菜</button></a>
            </h2>
                           
                            
<section class="order">
  <div class="orderlist">
    <ul id="ullist"><li class="ccbg2" id="notEnoughLi" style="display: none;">必须要满0元才能下单哦</li><li class="ccbg2" id="emptyLi" style="display: none;">购物车为空哦，快去挑选吧！</li></ul>
  </div>
</section> 
...
<td>
<div class="ui-input-text"><input type="text" id="name" name="name" value="<?php echo $m->name; ?>" placeholder="如：高xx曦21" class="ui-input-text"></div>
<input type="text" id="captch" name="captch" value="" style="display: none;" placeholder="如：高xx曦21" class="ui-input-text">
...
<td>
<div class="ui-input-text"><input type="tel" id="phone" name="phone" value="<?php echo $m->tel; ?>" placeholder="如：138888888882" class="ui-input-text"></div>
</td>
</tr>
...
<!--
<tr>
<td width="80px"><label for="tablenums" class="ui-input-text">桌号：</label></td>
<td colspan="2"><select name="tablenums" class="selectstyle" id="tablenums">
...
<!--
<table style=""  id="paypassword-layout">
<tbody><tr>
<td width="80px"><label for="paypassword" class="ui-input-text">交易密码：</label></td>
<td width="80px">
...
<table style="display:none" id="captcha-layout">
<tbody><tr>
<td width="80px"><label for="captcha" class="ui-input-text">验证码：</label></td>
<td width="80px"><div class="ui-input-text"><input type="tel" id="captcha" name="captcha" class="ui-input-text"></div></td>
...
<div class="footermenu">
    <ul>
        ...
        <li>
            <a class="active" href="<?php echo "gwc-".Request::get('1').".html?wxid=".$_GET['wxid']."#";?>mp.weixin.qq.com">
