...
<title>微调研设置</title><script type="text/javascript">var yyuc_jspath = "/@system/";</script><script type="text/javascript" src="/@system/js/jquery.js"></script><script type="text/javascript" src="/@system/js/yyucadapter.js"></script>
...
<body>
	...
	<div class="alert alert-info">
	  	...
	  	<p><span class="bold">当前地址：</span><?php echo getUrl('wdy'); ?></p>
	</div>
