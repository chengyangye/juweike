...
<title>会员卡设置</title><script type="text/javascript">var yyuc_jspath = "/@system/";</script><script type="text/javascript" src="/@system/js/jquery.js"></script><script type="text/javascript" src="/@system/js/yyucadapter.js"></script>
...
<body>
	...
	<div class="alert alert-info">
	  	...
	  	<p><span class="bold">当前地址：</span><?php echo getUrl('hyk'); ?></p>
	</div>
	<form class="form-horizontal" id="lbsForm" action="" method="post"><?php echo tk();  echo $lbs->hidden('id'); ?>
		...
		<div class="control-group">
	  	...
	  	<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					<table style="height: 30px;overflow: hidden;">
					<tr>
					<td><?php echo $lbs->upload('pic1',array('text'=>'上传图片','showdel'=>false,'type'=>'png,jpeg,jpg,gif,bmp','width'=>100),null,null,'picsethere1'); ?></td>
	  	...
	  	<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					<table style="height: 30px;overflow: hidden;">
					<tr>
					<td><?php echo $lbs->text('namecolor','class="color"'); ?></td>
	  	...
	  	<div class="control-group">
		    ...
		    <div class="controls">
			    <div class="cover-area">
					<table style="height: 30px;overflow: hidden;">
					<tr>
					<td><?php echo $lbs->text('numcolor','class="color"'); ?></td>
					<td valign="top" style="line-height: 30px;color:gray;"></td>
					</tr>
					</table>
					<p class="img-area cover-bd" id="picsethere2">
	  	...
	  	<div class="control-group">
			...
			<div class="controls">
			<?php echo $lbs->text('ms','class="span4" onblur="if($(this).val().length>18){ $(this).val($(this).val().substr(0,18));}"'); ?>
		...
		<div class="control-group">
			...
			<div class="controls">
			<?php echo $lbs->texteditor('sm',3, '520px','90px'); ?>
		...
		<div class="control-group">
			...
			<div class="controls">
			<?php echo $lbs->texteditor('tz',3, '520px','90px'); ?>
				<span class="maroon">*</span><br><span class="help-inline">最多为1000个字符。</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
			<?php echo $lbs->texteditor('tq',3, '520px','90px'); ?>
				<span class="maroon">*</span><br><span class="help-inline">最多为1000个字符。</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
			<?php echo $lbs->texteditor('jfhd',3, '520px','90px'); ?>
				<span class="maroon">*</span><br><span class="help-inline">最多为1000个字符。</span>
			</div>
		</div>
		<div class="control-group">
	  	...
	  	<div class="control-group">
	    	...
	    	<div class="controls">
	    	<?php echo $lbs->text('loc','class="span4"'); ?>
		    	<span class="maroon">*</span>
	  	...
	  	<div class="control-group">
	    	...
	    	<div class="controls">
	    	<?php echo $lbs->text('jf','class="span4"'); ?>
		    	<span class="maroon">*</span>
		    	<span class="help-inline"></span>
	    	</div>
	  	</div>
