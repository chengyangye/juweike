			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3><i class="icon-table"></i>业主服务管理</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="loupanhuxingadd.html" class="btn"><i class="icon-plus"></i>添加业主服务</a>
								...
								<div class="span4" style="text-align:right;">
									...
									<?php echo $tj->text('huxing','class="input-large" placeholder="请输入业主服务名称" '); ?>
								...
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											...
											<th class="span3">业主服务名称</th>
											<th class="span3">所属小区</th>
