            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3><i class="icon-table"></i>酒店管理 </h3>
                            </div>
                        </div>
                        ...
                        <div class="box-content">
                            ...
                            <div class="row-fluid">
                                <div class="span12 control-group">
                                    <div class="span4">
                                        <a class="btn" href="new.html"><i class="icon-plus"></i>新增订房</a>
                                    ...
                                    <table id="listTable" class="table table-bordered table-hover  dataTable">
                                        ...
                                        <?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>
                                        	<tr>                                               
                                               ...
                                               <td> 
                                                    <a href="record-<?php echo $r->id; ?>.html" class="btn" title="订单管理"><i class="icon-cog"></i>订单管理</a>
                                                    <a href="roomset-<?php echo $r->id; ?>.html" class="btn" title=""><i class="icon-cog"></i>房间设置</a>
