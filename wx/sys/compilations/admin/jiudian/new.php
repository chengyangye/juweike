            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>编辑酒店信息</h3>
                            </div>
                        ...
                        <div class="box-content">
                            <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate" id="lbsForm"><?php echo tk();  echo $m->hidden('id'); ?>
                                ...
                                <div class="control-group">
                                    <label for="title" class="control-label">酒店名称：</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label for="address" class="control-label">酒店地址：</label>
                                    <div class="controls">
                                         <?php echo $m->text('addr','class="input-xlarge" required="required"'); ?><span class="maroon">*</span>如<?php echo $_SERVER['DEMO_ADDR']; ?>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="tel" class="control-label">酒店电话：</label>
                                    <div class="controls">
                                        <?php echo $m->text('tel','class="input-xlarge" required="required"'); ?><span class="maroon">*</span>如<?php echo $_SERVER['DEMO_TEL']; ?>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label for="typename" class="control-label">列表模式：</label>
                                    <div class="controls" style="vertical-align: middle;padding-top: 5px;">
                                        <?php echo $m->radio(array('0'=>'无图','1'=>'有图'),'isroomlistpic','style="margin-top:-2px;"'); ?>                                        
                                    </div>
                                </div>


                                <div class="control-group">
                                    <label for="endinfo" class="control-label">商家图片：</label>
                                    <div class="controls">
                                        <div class="span12"><a href="javascript:addsjtp('sjtptr')" class="btn" id="add_menu"><i class="icon-plus"></i>添加图片</a></div>
                                        <table id="listTable" class="table table-bordered table-hover dataTable">
    <thead>
        <tr><th>文字描述</th><th>图片地址</th><th>图片跳转地址以http://开头</th><th>操作</th></tr>
    </thead>
    <tbody id="sjtptr">
        <tr style="display: none;">
            <td>
            <?php echo $m->text('ptxt1','class="input-small"'); ?><span class="maroon">*</span>
            </td>
            <td id="spicsettd1">
                <img class="thumb_img" src="<?php echo $m->psrc1; ?>" style="max-height: 100px;"><?php echo $m->hidden('psrc1'); ?>
                <span>
                    <button class="btn select_img" type="button" onclick="setpic('spicsettd1')">选择图片</button>
                </span>
            </td>
            <td>
            <?php echo $m->text('phref1','class="input-small"'); ?>
            </td>
            <td>
        ...
        <tr style="display: none;">
            <td>
            <?php echo $m->text('ptxt2','class="input-small"'); ?><span class="maroon">*</span>
            </td>
            <td id="spicsettd2">
                <img class="thumb_img" src="<?php echo $m->psrc2; ?>" style="max-height: 100px;"><?php echo $m->hidden('psrc2'); ?>
                <span>
                    <button class="btn select_img" type="button" onclick="setpic('spicsettd2')">选择图片</button>
                </span>
            </td>
            <td>
            <?php echo $m->text('phref2','class="input-small"'); ?>
            </td>
            <td>
                <a href="javascript:void(0);" onclick="delsjtp(this,'sjtptr')" class="del">删除 </a>
            </td>
        ...
        <tr style="display: none;">
            <td>
            <?php echo $m->text('ptxt3','class="input-small"'); ?><span class="maroon">*</span>
            </td>
            <td id="spicsettd3">
                <img class="thumb_img" src="<?php echo $m->psrc3; ?>" style="max-height: 100px;"><?php echo $m->hidden('psrc3'); ?>
                <span>
                    <button class="btn select_img" type="button" onclick="setpic('spicsettd3')">选择图片</button>
                </span>
            </td>
            <td>
            <?php echo $m->text('phref3','class="input-small"'); ?>
            </td>
            <td>
                <a href="javascript:void(0);" onclick="delsjtp(this,'sjtptr')" class="del">删除 </a>
            </td>
        ...
        <tr style="display: none;">
            <td>
            <?php echo $m->text('ptxt4','class="input-small"'); ?><span class="maroon">*</span>
            </td>
            <td id="spicsettd4">
                <img class="thumb_img" src="<?php echo $m->psrc4; ?>" style="max-height: 100px;"><?php echo $m->hidden('psrc4'); ?>
                <span>
                    <button class="btn select_img" type="button" onclick="setpic('spicsettd4')">选择图片</button>
                </span>
            </td>
            <td>
            <?php echo $m->text('phref4','class="input-small"'); ?>
            </td>
            <td>
                <a href="javascript:void(0);" onclick="delsjtp(this,'sjtptr')" class="del">删除 </a>
            </td>
        ...
        <tr style="display: none;">
            <td>
            <?php echo $m->text('ptxt5','class="input-small"'); ?><span class="maroon">*</span>
            </td>
            <td id="spicsettd5">
                <img class="thumb_img" src="<?php echo $m->psrc5; ?>" style="max-height: 100px;"><?php echo $m->hidden('psrc5'); ?>
                <span>
                    <button class="btn select_img" type="button" onclick="setpic('spicsettd5')">选择图片</button>
                </span>
            </td>
            <td>
            <?php echo $m->text('phref5','class="input-small"'); ?>
            </td>
            <td>
                <a href="javascript:void(0);" onclick="delsjtp(this,'sjtptr')" class="del">删除 </a>
            </td>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php echo $m->texteditor('des',3,'100%','150px'); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
								...
								<div class="control-group">
                                    ...
                                    <div class="controls" id="twfmpicarea">
										<?php echo Conf::$http_path; ?>wjd/index-<?php echo $m->id; ?>.html?wid=<?php echo Session::get('wid'); ?>
                                    </div>
                                </div>
                                <?php } ?>
