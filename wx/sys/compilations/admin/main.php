...
<body class="<?php echo Session::get('maintheme'); ?>">
	<div id="navigation">
        <div class="container-fluid" style="position:relative;">
            <div>
                <a href="javascript:;" target="_self" id="brand"><img src="<?php echo $_SERVER['LOGO_PIC2']; ?>" style="margin-top: 6px;"/></a>
            ...
            <ul class='main-nav'>
                ...
                <li><a href="ind.html" target="_self">公众帐号管理</a> </li>
            ...
            <div class="user">
                ...
                <div class="dropdown">
                    <a href="javascript:;" class='dropdown-toggle'  target="_self" data-toggle="dropdown" style="width:127px;"><nobr><?php echo $user->un; ?><span class="caret"></span><img class="thumb_img" src="<?php echo $user->headpic; ?>" id="pic_apartpic" style="max-width:40px" /></nobr></a>
    ...
    <div class="container-fluid" id="content">
        ...
        <?php $__i=0; foreach ((array)$index as $ind) { $__i++; ?>
       	<div class="subnav">
               <div class="subnav-title">
                   <a href="javascript:void(0);" class='toggle-subnav'><i class="icon-angle-right"></i><span><?php echo $ind['name']; ?></span></a>
               </div>
               <ul class="subnav-menu" style="display: none">
               <?php $__i=0; foreach ((array)$ind['sub'] as $in) { $__i++; ?>
               <li>
                  <a href="/admin/<?php echo $in['file']; ?>.html"><?php echo $in['name']; ?></a>
               </li>
               <?php } ?>
               </ul>
        </div>
        ...
        <div class="right">
            <div class="main">
                <iframe frameborder="0" id="mainFrame" name="mainFrame" src="/admin/userCenter/welcom.html" style="background: url('http://wx.zongyangtech.cn/static/wxgjcn/weiqin/loading.gif') center no-repeat"></iframe>
            </div>
        </div>
