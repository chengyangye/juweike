			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3><i class="icon-table"></i>KTV包厢管理</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="loupanhuxingadd.html" class="btn"><i class="icon-plus"></i>添加KTV包厢</a>
								...
								<div class="span4" style="text-align:right;">
									...
									<?php echo $tj->text('huxing','class="input-large" placeholder="请输入KTV包厢名称" '); ?>
								...
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											...
											<th class="span3">KTV包厢名称</th>
											<th class="span3">所属KTV分店</th>
