			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3><i class="icon-table"></i>服务点评管理</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="zhuanjiadianpingadd.html" class="btn"><i class="icon-plus"></i>添加点评</a>
									<div class="btn-group datatabletool">
										<a class="btn" title="删除" onclick="dellbs('zhuanjiadianping','a',this);"><i class="icon-trash"></i></a>
									</div>
								</div>
								<div class="span4" style="text-align:right;">
									<form action="" class="form-horizontal form-validate">
										<?php echo $tj->text('title','class="input-large" placeholder="请输入点评标题" '); ?>
								...
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											...
											<th class="span3">点评标题</th>
											<th class="span3">客户</th>
									...
									<?php $__i=0; foreach ((array)$res as $r ) { $__i++; ?>
									  <tr>
									     ...
									     <td>
									     	<a href="zhuanjiadianpingadd-<?php echo $r->id; ?>.html" class="btn"><i class="icon-edit"></i></a>
										   <a href="javascript:;" class="btn" onclick="dellbs('zhuanjiadianping',<?php echo $r->id; ?>,this)"><i class="icon-remove"></i></a>
									     </td>
									  </tr>
									  <?php } ?>
									  <?php }else{ ?>
																			<tr>
											<td colspan="6" style="text-align:center; height:30px;">没有任何KTV包厢信息</td>
										</tr>
										<?php } ?>
																	</table>
															</div>
