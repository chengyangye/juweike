						...
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="loupanhuxing.html" class="btn"><i class="icon-reply"></i>返回KTV包厢</a>
									<a href="loupanhuxingquanjingadd.html" class="btn"><i class="icon-plus"></i>添加全景图</a>
									<div class="btn-group datatabletool">
										<a class="btn" title="删除" onclick="dellbs('loupanhuxingquanjing','a',this);"><i class="icon-trash"></i></a>
									</div>
								...
								<div class="span4" style="text-align:right;">
									<form action="" class="form-horizontal form-validate">
									    <?php echo $tj->text('name','class="input-large" placeholder="请输入全景图标题" '); ?>
									 ...
									 <?php $__i=0; foreach ((array)$res  as $r) { $__i++; ?>
											<tr>
												<td class="with-checkbox">
													<input type="checkbox" name="check" value="<?php echo $r->id; ?>" />
												</td>
												<td><?php echo $r->name; ?></td>
											
												<td>
													<a href="loupanhuxingquanjingadd-<?php echo $r->id; ?>.html" class="btn"><i class="icon-edit"></i></a>
													<a href="javascript:;" onclick="dellbs('loupanhuxingquanjing',<?php echo $r->id; ?>,this)" class="btn"><i class="icon-remove"></i></a>
												</td>
											</tr>
									<?php } ?>													
									<?php }else{ ?>
...
<script type="text/javascript" src="<?php echo $JS; ?>comm.js"></script>	<script>
