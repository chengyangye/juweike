            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3><i class="icon-table"></i>销售顾问管理</h3>
                            </div>
                        ...
                        <div class="box-content">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span12 control-group">
                                    <a href="xiaoshouadd.html" class="btn" id="add_menu"><i class="icon-plus"></i>添加销售顾问</a>
                                    <div class="btn-group datatabletool">
                                        <a class="btn" title="删除" onclick="dellbs('xiaoshou','a',this)"><i class="icon-trash"></i></a>
                                    </div>
                                </div>
                                ...
                                <table id="listTable" class="table table-bordered table-hover dataTable">
                                    <thead>
									   ...
									   <?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>
                                        ...
                                        <td><img src="<?php echo $r->pic; ?>" style="max-height:50px;"/></td>
                                        <td><?php echo $r->name; ?></td>
                                        <td><?php echo $r->tel; ?></td>
                                        <td><?php echo $type_arr[$r->type]; ?></td>
                                        <td><?php echo $r->sort; ?></td>
                                        <td class="input-medium">
                                             <a class="btn" href="xiaoshouadd-<?php echo $r->id; ?>.html" title="编辑"><i class="icon-edit"></i></a>
                                            <a class="btn" href="javascript:void(0);" title="删除" onclick="dellbs('xiaoshou',<?php echo $r->id; ?>,this);"><i class="icon-remove"></i></a></td>
                                    </tr>
									   <?php } ?>
									                                </table>
									                                
								链接地址：<?php echo Conf::$http_path; ?>wqc/xiaoshou.html?wid=<?php echo Session::get('wid'); ?>
