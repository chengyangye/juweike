            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span12">
                                <h3><i class="icon-cog"></i>微汽车--关键字</h3>
                            </div>
                        </div>
                        <div class="box-content">
                            <form action="" method="post" class="form-horizontal form-validate"><?php echo tk();  echo $set->hidden('id'); ?>
                                    ...
                                    <label class="control-label" for="cover">图文消息封面</label>
									  <div class="controls">
										...
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_pic','micro_car_keywordpic');">选择封面</button>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
										<?php echo $set->textarea('ms',' required="required" class="input-large" style="height:80px;width:380px;"'); ?>	
                                        <span class="maroon">*</span>
                                        <span class="help-block">150文字以内</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="brief">汽车首页</label>
                                    <div class="controls">
										<?php echo $set->select($xw_arr,'xwid'); ?>	
                                        <span class="maroon"></span>
                               ...
                               <!--  <?php if ($set->has_id()){ ?>
								<div class="control-group">
                                    ...
                                    <div class="controls" id="twfmpicarea">
										<?php echo Conf::$http_path; ?>wqc/keyword-<?php echo $set->id; ?>.html?wid=<?php echo Session::get('wid'); ?>
                                    </div>
                                </div>
                                <?php } ?> -->
