            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3><i class="icon-table"></i>预约试驾 </h3>
                            </div>
                        </div>
                        ...
                        <div class="box-content">
                            ...
                            <div class="row-fluid">
                                <div class="span12 control-group">
                                    <div class="span4">
                                        <a class="btn" href="yysjnew.html"><i class="icon-edit"></i>编辑预约</a>
                                    ...
                                    <table id="listTable" class="table table-bordered table-hover  dataTable">
                                        ...
                                        <?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>
                                        	<tr>                                               
                                               ...
                                               <td> 
                                                    <a href="yysjrecord-<?php echo $r->id; ?>.html" class="btn" title="订单管理"><i class="icon-cog"></i>订单管理</a>
											   </td>
                                            </tr>
										<?php } ?>									                                        </tbody>
                                    </table>
