            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3><i class="icon-table"></i>预约保养 </h3>
                            </div>
                        </div>
                        ...
                        <div class="box-content">
                            ...
                            <div class="row-fluid">
                                <div class="span12 control-group">
                                    <div class="span4">
                                        <a class="btn" href="yybynew.html"><i class="icon-plus"></i>编辑预约</a>
                                        ...
                                        <?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>
                                        	<tr>                                               
                                               ...
                                               <td> 
                                                    ...
                                                    <!-- 
                                                    <a class="btn" href="yybynew-<?php echo $r->id; ?>.html" title="编辑"><i class="icon-edit"></i>编辑</a> 
