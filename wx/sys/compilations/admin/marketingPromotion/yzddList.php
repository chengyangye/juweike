...
<body>
	<div class="main-title">
		<h3><?php echo $lbs->name; ?>一战到底活动</h3>
	</div>
...
<div>
<form action="yzddList-<?php echo $lbs->id; ?>.html">
手机号：
	...
	<table class="table table-bordered">
			...
			<?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>			 
			      <tr>
						...
						<td><?php echo $r->tms; ?></td>
						<td><?php echo $r->zqs; ?></td>
						<td><?php echo $r->jrtms; ?></td>
						<td><?php echo $r->jt+1; ?></td>
