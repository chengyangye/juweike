...
<div class="pagination">
  <ul>
    ...
    <div class="tb-toolbar">
		<a href="discountCouponadd.html" class="btn btn-small btn-primary">新增</a>
	...
	<table class="table table-bordered">
			...
			<?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>			 
			      <tr>
						...
						<span>
						[
						<a href="discountCouponadd-<?php echo $r->id; ?>.html">修改</a>
						]
						</span>
						<span>
						[
						...
						<span>
						[
						<a href="discountCouponlist-<?php echo $r->id; ?>.html" >数据监测</a>
						]
						</span>
						</td>
				  </tr>
...
$(function() {
	$("#gotonext").click(function(){
		window.parent.$('.menu-ggk').trigger('click');
	});
});
...
<div id="gotonext">
	<img src="<?php echo $IMG; ?>/admin/v3/guaguaka.png" ></img>
</div>
<br/><br/><br/></body></html>