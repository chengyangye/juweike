...
<div class="content-box role">
	...
	<div class="content-box-content">
		<div class="default-tab" >
		    ...
		    <label>账号</label><?php echo $tj->select($un,'aid'); ?>
		...
		<div class="tab-content default-tab" >
			<table>
				<thead>
					<tr>
			<th style="padding-left:5px;border-left:1px solid #C1DAD7">序号</th><th>账号</th><th>充值金额</th><th>充值时间</th><th>备注</th>				</tr>
				</thead>
				<tbody>
