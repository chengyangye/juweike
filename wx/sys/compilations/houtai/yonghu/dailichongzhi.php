...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
   <tr>
        ...
        <td colspan="2" align="left" height="15">￥<span id="wdyespan" style="color: red;"><?php echo $ma->yue; ?></span></td>
    </tr>
    <tr>
        ...
        <?php }else{ ?>
        <span id="dlzkspan" style="color:red;"><?php echo $prc_arr[$ua->level]; ?></span>%
        <?php } ?>
        </td>
    </tr>
    <tr>
...
$(function(){
	$('#czje').on('click change keyup mouseup blur',function(){
		var zk = parseInt($('#dlzkspan').text());
