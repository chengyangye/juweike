...
<div class="content-box role">
	...
	<div class="content-box-content">
		...
		<div class="searchgrid">
			...
			<label>用户级别</label><?php echo $m->select($dl_arr,'typid','onchange="goto(\'yonghuquanxian-\'+$(this).val()+\'.html\')"'); ?>	
		...
		<div class="tab-content default-tab" >
			<table>
			<?php $__i=0; foreach ((array)$index as $k=>$m) { $__i++; ?>
			...
			<input type='checkbox' name='<?php echo $mm['file']; ?>' value='1' checked="checked"/><?php echo $mm['name']; ?>;
			<?php } ?>
			</td></tr>
			<?php } ?>
