...
<div class="content-box role">
	...
	<div class="content-box-content">
		<div class="default-tab" >
			...
			<label>部门职务</label>
			<?php echo $tj->select($dl_arr,'level'); ?>
			<label>状态</label>
		...
		<div class="tab-content default-tab" >
			...
			<th style="padding-left:5px;border-left:1px solid #C1DAD7">序号</th><th>账号</th><th>姓名</th><th>职务</th><th>剩余费用(￥)</th><th>手机</th><th>QQ</th><th>状态</th><th>操作</th>
				...
				<?php $__i=0; foreach ((array)$res as $r) { $__i++; ?>
					...
					<td>
					<a href="xinzengyuangong-<?php echo $r->id; ?>.html"><?php echo $r->un; ?></a>
					</td>
					<td>
					<?php echo $r->name; ?>
					</td>
					...
					<a href="/houtai/daili/lowerAgency-<?php echo $r->id; ?>-<?php echo md5($r->id.$mu->pwd); ?>.html">下级代理</a>&nbsp;|&nbsp;
					<a href="/houtai/yonghu/lowerUser-<?php echo $r->id; ?>-<?php echo md5($r->id.$mu->pwd); ?>.html">下级用户</a>&nbsp;|&nbsp;
					<a href="xinzengyuangong-<?php echo $r->id; ?>.html">编辑【查看】</a>
					</td>
					</TR>
				<?php } ?>
				</tbody>
