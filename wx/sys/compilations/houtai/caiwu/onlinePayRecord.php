...
<div class="content-box role">
	...
	<div class="content-box-content">
		<div class="default-tab" >
		    ...
		    <label>账号</label><?php echo $tj->text('name'); ?>
		     <label>状态</label><?php echo $tj->select($status_arr,'status'); ?>
		...
		<div class="tab-content default-tab" >
			<table>
				<thead>
					<tr>
			<th style="padding-left:5px;border-left:1px solid #C1DAD7">序号</th><th>账号</th><th>充值金额</th><th>购买月数</th><th>购买级别</th><th>充值时间</th><th>状态</th>				</tr>
				</thead>
				<tbody>
