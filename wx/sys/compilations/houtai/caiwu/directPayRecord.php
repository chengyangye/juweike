...
<div class="content-box role">
	<div class="content-box-header">
		<h3>当前登录角色：<?php echo $user_role; ?>, 累计充值总金额:<?php echo $payTotal; ?></h3>
		<div class="clear"></div>
	</div>
	<div class="content-box-content">
		<div class="default-tab" >
		    ...
		    <label>客户账号</label><?php echo $tj->text('aun'); ?>
		    <br/>
		    <label>归属客服</label><?php echo $tj->text('kun'); ?>
		    <label>归属财务</label><?php echo $tj->text('cun'); ?>
		    <label>归属业务</label><?php echo $tj->text('pun'); ?>
		...
		<div class="tab-content default-tab" >
			<table>
				<thead>
					<tr>
			<th style="padding-left:5px;border-left:1px solid #C1DAD7">序号</th><th>充值人</th><th>被充值人</th><th>归属客服</th><th>归属财务</th><th>归属业务</th><th>充值金额</th><th>购买月数</th><th>购买级别</th><th>充值时间</th><th>备注</th>				</tr>
				</thead>
				<tbody>
