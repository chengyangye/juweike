...
/////////////////////数据库配置 编码必须为 utf-8
	...
	/**数据库名~*/
	public static $db_dbname = "test_juweike";
	/**数据库用户名~*/
	public static $db_username = "root";
	/**数据库密码~*/
	public static $db_password = "cs2c666666";
...
/////////////////////常用配置	
	...
	public static $need_db_log = false;
	...
	/**系统日志级别~0：不输出日志，1：错误信息输出，2：警告和错误信息输出，3：提示、警告和错误信息输出4：提示、警告、错误和调试信息输出，日志地址:yyuc/log*/
	...
	/**Jquery Url~Jquery的加载地址,默认为空。不设置则从框架加载,因特网环境推荐为:http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js*/
...
/////////////////////系统自动检测的配置信息,修改无效
	...
	/**代码块同步时间~单位:秒,供CodeSynchronize类调用。类似java的synchronize。php非线程安全模式下可考虑使用。如果超出此时间持有代码锁的进程将失去对此代码块的独占,即允许另一进程进入此代码块*/
	public static $code_syn_time = 20;
...
/////////////////////缓存配置
	...
	public static $session_prefix = "ZZBWX_";
}
?>
